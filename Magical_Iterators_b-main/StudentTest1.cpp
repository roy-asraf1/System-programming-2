...
TEST_CASE("Comparing PrimeIterator") {
    ...
    SUBCASE("Comparing iterators after increments") {
        ...
        CHECK_FALSE((it1 < it2));
        CHECK((it1 > it2));
        cout<<*it1<<"aaaaaaaaaaaaaa"<<endl;
        cout<<*it2<<"bbbbbbbbb"<<endl;
        ++it2;
        CHECK((it1 == it2));
        ...
        CHECK((it1 != it2));
        CHECK((it1 > it2));
        cout<<"the val of it1 is:"<<*it1<<endl;
        cout<<"the val of it2 is:"<<*it2<<endl;
        CHECK_FALSE((it1 < it2));
